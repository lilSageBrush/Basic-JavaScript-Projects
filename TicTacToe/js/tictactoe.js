...
// This function is for pacing an x or p in a square.
function placeXOrO(squareNumber) {

    // ***A note to The Tech Academy staff, there's a typo in the below note, it origionally said, "hasn't be selected" when it should be "been" I've placed the error between stars
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        // Acive placyer may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            // If activePlayer is equal to 'O', the o.png is placed in HTML.
            select.style.backgroundImage = 'url("images/o.png")';
        }
        // squareNumber and activePlayre are concatenated together and addded to array.
        selectedSquares.push(squareNumber + activePlayer);
        // This calls a function to check for any win conditions.
        checkWinConditions();
        // this condition is for changing the active player.
        if (activePlayer === 'X') {
            //If actiive player is 'X' change it to 'O'.
            activePlayer = 'O';
        ...
        if (activePlayer === 'O') {
            // This function diables clicking for the computers choice.
            disableClick();
    ...
    function computersTurn() {
        ...
        while(!success) {
            ...
            // IF the random number evaluatuation returns ture, the square hasn't been selected yet.
...
// drawWithLine function is called to draaw line if condition is met.
...
function audio(audioURL) {
    // we create a new ausio object and we pass the path as a parameter.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
    // This indicates where the start of a lines y axis is.
        y1 = coordY1,
    ...
    function animateLineDrawing() {
        ...
        c.lineTo(x, y);
        // This method sets the witdh of our line.
        c.lineWidth = 10;
        // This method sets the color of our line.
        c.strokeStyle = 'rgba(0, 0, 0, .8)';
        // This method drawas everything we laid out above.
        c.stroke();
        // This conditon checks if we've reached the endpoint
        if (x1 <= x2 && y1 <= y2) {
            // This condition adds 10 to the previous end x point.
            if (x < x2) { x += 10; }
            //This condition adds 10 to the previous end y point.
            if (y < y2) { y += 10; }
            // This condition cancels our animarion looop if it reaches the end point.
    ...
    function clear() {
        ...
        c.clearRect(0, 0, 608, 608);
        // This line stops oru animation loop.
